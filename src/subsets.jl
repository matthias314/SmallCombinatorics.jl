...
[`combinations`](@ref combinations(::Union{Integer, SmallBitSet, AbstractSmallSet, AbstractFixedOrSmallOrPackedVector}, ::Integer)),
[`setcompositions_parity`](@ref setcompositions_parity(::Vararg{Integer,N}) where N).
...
See also [`subsets`](@ref subsets(::Union{SmallBitSet, AbstractSmallSet, Integer}, ::Integer)).
...
eltype(::Type{Combinations2{S}}) where S <: SmallSet = S
